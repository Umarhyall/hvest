...
class RegisterUmkm1onView extends GetView<RegisterUmkm1onController> {
  const RegisterUmkm1onView({Key? key}) : super(key: key);
  @override
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            InkWell(
              onTap: () {
                Get.toNamed(AppRoutes.inforekeningview);
              },
              child: opsi(
                width: width,
